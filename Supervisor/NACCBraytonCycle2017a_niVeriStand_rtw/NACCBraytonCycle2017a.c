...
static void NACCBraytonCycle2017a_output(void)
{
  ...
  for (i = 0; i < 7; i++) {
     ...
     */
    rtb_MinMax_j += NACCBraytonCycle2017a_B.psi_eg[i] *
   ...
   *  Sum: '<S32>/Add'
   */
  NACCBraytonCycle2017a_Y.Out1 = NACCBraytonCycle2017a_B.ndot_lp * rtb_MinMax_j *
    NACCBraytonCycle2017a_P.Gain2_Gain_a3 * NACCBraytonCycle2017a_P.Gain1_Gain_g
   ...
   *  Sum: '<S19>/Add'
   */
  NACCBraytonCycle2017a_Y.Out5 = NACCBraytonCycle2017a_B.ndot_e * rtb_MinMax_j *
    NACCBraytonCycle2017a_P.Gain2_Gain_mh * NACCBraytonCycle2017a_P.Gain1_Gain_p
  ...
  for (i = 0; i < 7; i++) {
    ...
    /* Memory: '<S12>/Memory4' */
    NACCBraytonCycle2017a_B.psi_m[i] =
      NACCBraytonCycle2017a_DW.Memory4_PreviousInput_m[i];
    rtb_Product8_m[i] = NACCBraytonCycle2017a_B.psi_m[i] *
      NACCBraytonCycle2017a_P.th_M[i];
  }
   ...
   *  Memory: '<S9>/Memory2'
   */
  rtb_UnitOffset = NACCBraytonCycle2017a_P.Gain1_Gain_mv *
    NACCBraytonCycle2017a_DW.Memory2_PreviousInput_o +
    NACCBraytonCycle2017a_P.additionfactor1_Value_c;

  /* Outport: '<Root>/Out11' */
  NACCBraytonCycle2017a_Y.Out11 = rtb_UnitOffset;
  ...
  /* Memory: '<S12>/Memory9' */
  NACCBraytonCycle2017a_B.ndot_f =
   ...
   *  Sum: '<S45>/Add'
   */
  NACCBraytonCycle2017a_Y.Out13 = NACCBraytonCycle2017a_B.ndot_f * rtb_Sum2_p5 *
    NACCBraytonCycle2017a_P.Gain2_Gain_o * NACCBraytonCycle2017a_P.Gain1_Gain_n0
  ...
  NACCBraytonCycle2017a_Y.Out14 = NACCBraytonCycle2017a_P.Gain1_Gain_o *
    NACCBraytonCycle2017a_DW.Memory1_PreviousInput_j +
  ...
  NACCBraytonCycle2017a_Y.Out17 =
    NACCBraytonCycle2017a_DW.Memory9_PreviousInput_a * rtb_Sum2_p5 *
  ...
  NACCBrayton_calculateconversion
    (NACCBraytonCycle2017a_P.CombustionChamber1_reaction,
     ...
     NACCBraytonCycle2017a_P.Constant4_Value_e,
  ...
  NACCBraytonCycle2017a_B.Product =
    ...
    NACCBraytonCycle2017a_DW.Memory9_PreviousInput_aq;
  ...
  /* Sum: '<S74>/Sum2' */
  rtb_MultiportSwitch1_f = rtb_Product8_m[0];
  for (i = 0; i < 6; i++) {
    /* Product: '<S74>/Product8' incorporates:
     *  Constant: '<S75>/M1'
     *  Memory: '<S10>/Memory4'
     ...
     */
    rtb_MultiportSwitch1_f += rtb_Product8_m[i + 1];
  }

  /* Product: '<S74>/Product11' incorporates:
   *  Memory: '<S10>/Memory9'
   */
  rtb_Sum2_p5 = NACCBraytonCycle2017a_DW.Memory9_PreviousInput_aq *
    rtb_MultiportSwitch1_f;
   ...
   *  Memory: '<S10>/Memory2'
   */
  rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_DW.Memory2_PreviousInput_h -
    rtb_Sum2_p5 * rtb_Sum2_p5 * NACCBraytonCycle2017a_P.Gain_Gain_g;

  /* MinMax: '<S72>/MinMax' incorporates:
   *  Constant: '<S72>/p_downstrem_min'
   */
  if (!((rtb_MultiportSwitch1_f >
         NACCBraytonCycle2017a_P.p_downstrem_min_Value_p) || rtIsNaN
        (NACCBraytonCycle2017a_P.p_downstrem_min_Value_p))) {
    rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_P.p_downstrem_min_Value_p;
  }

  /* End of MinMax: '<S72>/MinMax' */

  /* Saturate: '<S72>/Saturation' */
  if (rtb_MultiportSwitch1_f > NACCBraytonCycle2017a_P.Saturation_UpperSat_j) {
    NACCBraytonCycle2017a_B.Saturation =
      NACCBraytonCycle2017a_P.Saturation_UpperSat_j;
  } else if (rtb_MultiportSwitch1_f <
             NACCBraytonCycle2017a_P.Saturation_LowerSat_k) {
    NACCBraytonCycle2017a_B.Saturation =
      NACCBraytonCycle2017a_P.Saturation_LowerSat_k;
  } else {
    NACCBraytonCycle2017a_B.Saturation = rtb_MultiportSwitch1_f;
  }
  ...
  NACCBraytonCycle2017a_B.Hdot =
    NACCBraytonCycle2017a_DW.Memory3_PreviousInput_l;
  ...
  /* Block <S71>/S-Function*/
  {
    ...
    inflow.Hdot_ = &NACCBraytonCycle2017a_B.Hdot;
    ...
    outflow.psi = &NACCBraytonCycle2017a_B.psi_pj[0];
  ...
  /* Sum: '<S294>/Sum2' */
  rtb_MultiportSwitch1_f = -0.0;
  for (i = 0; i < 7; i++) {
    /* Sum: '<S294>/Sum2' incorporates:
     *  Constant: '<S298>/M1'
     *  Product: '<S294>/Product8'
     */
    rtb_MultiportSwitch1_f += NACCBraytonCycle2017a_B.psi_pj[i] *
      NACCBraytonCycle2017a_P.th_M[i];

    /* Memory: '<S7>/Memory4' */
    NACCBraytonCycle2017a_B.psi_p[i] =
      NACCBraytonCycle2017a_DW.Memory4_PreviousInput_l[i];
  }
  ...
  NACCBraytonCycle2017a_Y.Out21 = NACCBraytonCycle2017a_B.ndot_oo *
    rtb_MultiportSwitch1_f * NACCBraytonCycle2017a_P.Gain2_Gain_e *
   ...
   *  Gain: '<S26>/Gain1'
   */
  rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_P.Gain1_Gain_is *
    NACCBraytonCycle2017a_B.p_k +
    NACCBraytonCycle2017a_P.additionfactor1_Value_hp;

  /* Outport: '<Root>/Out23' */
  NACCBraytonCycle2017a_Y.Out23 = rtb_MultiportSwitch1_f;
   ...
   *  Memory: '<S7>/Memory1'
   */
  rtb_Sum2_p5 = NACCBraytonCycle2017a_DW.Memory1_PreviousInput_m /
   ...
   *  Constant: '<S15>/RPM'
   */
  rtb_MinMax_j = NACCBraytonCycle2017a_P.RPM_Value / rtb_Sum2_p5;
   ...
   *  Switch: '<S144>/Switch'
   */
  if (rtb_MinMax_j > NACCBraytonCycle2017a_P.Constant_Value_j) {
    rtb_Switch2 = NACCBraytonCycle2017a_P.Constant_Value_j;
  } else if (rtb_MinMax_j < NACCBraytonCycle2017a_P.Constant4_Value_d) {
    /* Switch: '<S144>/Switch' incorporates:
     *  Constant: '<S132>/Constant4'
     */
    rtb_Switch2 = NACCBraytonCycle2017a_P.Constant4_Value_d;
  } else {
    rtb_Switch2 = rtb_MinMax_j;
  }
   ...
   *  Inport: '<Root>/In11'
   */
  rtb_MultiportSwitch1_f *= NACCBraytonCycle2017a_U.In11 *
    NACCBraytonCycle2017a_P.Constant11_Value;
   ...
   *  Switch: '<S137>/Switch'
   */
  if (rtb_MultiportSwitch1_f > NACCBraytonCycle2017a_DW.Memory2_PreviousInput_dm)
  {
    NACCBraytonCycle2017a_B.Switch2 =
      NACCBraytonCycle2017a_DW.Memory2_PreviousInput_dm;
  } else if (rtb_MultiportSwitch1_f < NACCBraytonCycle2017a_P.Constant1_Value_e)
  {
    ...
    NACCBraytonCycle2017a_B.Switch2 = rtb_MultiportSwitch1_f;
  }
  ...
  if ((int32_T)NACCBraytonCycle2017a_P.LPGasTurbine_Mode == 1) {
    NACCBraytonCycle2017a_B.MultiportSwitch =
      NACCBraytonCycle2017a_DW.Memory9_PreviousInput_k;
  } else {
     ...
     *  Sum: '<S132>/Add2'
     */
    rtb_MultiportSwitch1_f = (((real_T)(rtb_MinMax_j >
      NACCBraytonCycle2017a_P.CompareToConstant1_const) * rtb_MinMax_j /
      NACCBraytonCycle2017a_P.Constant1_Value_h + (real_T)((rtb_MinMax_j >=
      NACCBraytonCycle2017a_P.CompareToConstant5_const) && (rtb_MinMax_j <=
      NACCBraytonCycle2017a_P.CompareToConstant6_const))) + (real_T)
      (rtb_MinMax_j < NACCBraytonCycle2017a_P.CompareToConstant2_const) *
      rtb_MinMax_j / NACCBraytonCycle2017a_P.Constant2_Value_e) *
      rtb_mdotequivalent;

    /* Saturate: '<S132>/Saturation' */
    if (rtb_MultiportSwitch1_f > NACCBraytonCycle2017a_P.Saturation_UpperSat_e)
    {
      rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_P.Saturation_UpperSat_e;
    } else {
      if (rtb_MultiportSwitch1_f < NACCBraytonCycle2017a_P.Saturation_LowerSat_i)
      {
        rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_P.Saturation_LowerSat_i;
      }
    }
     ...
     */
    rtb_Sum2_p5 = NACCBraytonCycle2017a_DW.Memory2_PreviousInput_dm /
      NACCBraytonCycle2017a_P.pnormal_Value_k / rtb_Sum2_p5 *
      rtb_MultiportSwitch1_f;
    ...
    NACCBraytonCycle2017a_B.MultiportSwitch = 1.0 / rtb_MultiportSwitch1_f *
      rtb_Sum2_p5;
  }
  ...
  if ((int32_T)NACCBraytonCycle2017a_P.LPGasTurbine_Mode == 1) {
    ...
    rtb_MultiportSwitch1_f = rtb_EfficiencyLookupTable;
  } else {
    ...
    if (rtb_u > NACCBraytonCycle2017a_P.Saturation1_UpperSat_m) {
      rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_P.Saturation1_UpperSat_m;
    } else if (rtb_u < NACCBraytonCycle2017a_P.Saturation1_LowerSat_n) {
      rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_P.Saturation1_LowerSat_n;
    } else {
      rtb_MultiportSwitch1_f = rtb_u;
    }
   ...
   *  Sum: '<S129>/Sum3'
   */
  rtb_MultiportSwitch1_f = (NACCBraytonCycle2017a_B.Hdot_d -
    NACCBraytonCycle2017a_B.Hdot_h) * (NACCBraytonCycle2017a_P.Gain1_Gain_fh *
    rtb_MultiportSwitch1_f);

  /* Saturate: '<S129>/Saturation1' */
  if (rtb_MultiportSwitch1_f > NACCBraytonCycle2017a_P.Saturation1_UpperSat_a) {
    rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_P.Saturation1_UpperSat_a;
  } else {
    if (rtb_MultiportSwitch1_f < NACCBraytonCycle2017a_P.Saturation1_LowerSat_l)
    {
      rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_P.Saturation1_LowerSat_l;
    }
  }
  ...
  /* Sum: '<S129>/Subtract2' */
  NACCBraytonCycle2017a_B.Subtract2 = rtb_MultiportSwitch1_f +
  ...
  /* Block <S131>/S-Function*/
  {
    ...
    outflow.psi = &NACCBraytonCycle2017a_B.psi_mv[0];
   ...
   *  Constant: '<S397>/M1'
   */
  rtb_Product8_m[0] = NACCBraytonCycle2017a_B.psi_mv[0] *
    NACCBraytonCycle2017a_P.th_M[0];
  ...
  for (i = 0; i < 6; i++) {
     ...
     *  Constant: '<S397>/M1'
     */
    rtb_Product8_m[i + 1] = NACCBraytonCycle2017a_B.psi_mv[i + 1] *
      NACCBraytonCycle2017a_P.th_M[i + 1];
  ...
  NACCBraytonCycle2017a_Y.Out25 = NACCBraytonCycle2017a_B.ndot_c *
    rtb_MultiportSwitch1_f * NACCBraytonCycle2017a_P.Gain2_Gain_h *
  ...
  NACCBrayton_calculateconversion
    (NACCBraytonCycle2017a_P.CombustionChamber_reaction,
     ...
     NACCBraytonCycle2017a_P.Constant1_Value_f,
     &NACCBraytonCycle2017a_B.calculateconversion_l,
     (P_calculateconversion_NACCBra_T *)
     &NACCBraytonCycle2017a_P.calculateconversion_l);
   ...
   *  Memory: '<S11>/Memory9'
   */
  NACCBraytonCycle2017a_B.Product_p =
    NACCBraytonCycle2017a_B.calculateconversion_l.Subtract5 *
   ...
   *  Memory: '<S11>/Memory4'
   */
  rtb_Product8_m[0] = NACCBraytonCycle2017a_DW.Memory4_PreviousInput_i[0] *
    NACCBraytonCycle2017a_P.th_M[0];
  ...
  for (i = 0; i < 6; i++) {
     ...
     *  Memory: '<S11>/Memory4'
     */
    rtb_Product8_m[i + 1] = NACCBraytonCycle2017a_DW.Memory4_PreviousInput_i[i +
      1] * NACCBraytonCycle2017a_P.th_M[i + 1];
   ...
   *  Memory: '<S11>/Memory9'
   */
  rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_DW.Memory9_PreviousInput_b *
    rtb_Sum2_p5;
   ...
   *  Memory: '<S11>/Memory2'
   */
  rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_DW.Memory2_PreviousInput_e -
    rtb_MultiportSwitch1_f * rtb_MultiportSwitch1_f *
   ...
   */
  if (!((rtb_MultiportSwitch1_f >
         NACCBraytonCycle2017a_P.p_downstrem_min_Value_b) || rtIsNaN
        (NACCBraytonCycle2017a_P.p_downstrem_min_Value_b))) {
    rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_P.p_downstrem_min_Value_b;
  }

  /* End of MinMax: '<S64>/MinMax' */

  /* Saturate: '<S64>/Saturation' */
  if (rtb_MultiportSwitch1_f > NACCBraytonCycle2017a_P.Saturation_UpperSat_a) {
    ...
    NACCBraytonCycle2017a_B.Saturation_l = rtb_MultiportSwitch1_f;
  }

  /* End of Saturate: '<S64>/Saturation' */

  /* Memory: '<S11>/Memory3' */
  NACCBraytonCycle2017a_B.Hdot_g =
  ...
  /* Block <S63>/S-Function*/
  {
    ...
    /* Map inputs */
    inflow.nr_flows = 1;
    inflow.ndot_ = &NACCBraytonCycle2017a_B.Product_p;
    inflow.p_ = &NACCBraytonCycle2017a_B.Saturation_l;
    inflow.psi = &NACCBraytonCycle2017a_B.calculateconversion_l.Product6[0];
    inflow.Hdot_ = &NACCBraytonCycle2017a_B.Hdot_g;
   ...
   *  Sum: '<S86>/Subtract'
   */
  rtb_MultiportSwitch1_f = (NACCBraytonCycle2017a_DW.Memory1_PreviousInput_l[0]
   ...
   */
  rtb_MultiportSwitch1_f = ((((0.0116 * rt_powd_snf(rtb_MultiportSwitch1_f, 5.0)
    - 6.0e-16 * rt_powd_snf(rtb_MultiportSwitch1_f, 4.0)) + 0.0148 * rt_powd_snf
    (rtb_MultiportSwitch1_f, 3.0)) + 7.0e-16 * rt_powd_snf
    (rtb_MultiportSwitch1_f, 2.0)) + 0.0064 * rtb_MultiportSwitch1_f) *
    NACCBraytonCycle2017a_P.p_Relaxation_Gain +
    NACCBraytonCycle2017a_P.Constant_Value_l;

  /* Saturate: '<S86>/Saturation' */
  if (rtb_MultiportSwitch1_f > NACCBraytonCycle2017a_P.Saturation_UpperSat_p) {
    rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_P.Saturation_UpperSat_p;
  } else {
    if (rtb_MultiportSwitch1_f < NACCBraytonCycle2017a_P.Saturation_LowerSat_kk)
    {
      rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_P.Saturation_LowerSat_kk;
    }
  }
   ...
   *  Memory: '<S86>/Memory'
   */
  NACCBraytonCycle2017a_B.Product1 = rtb_MultiportSwitch1_f *
  ...
  if ((int32_T)NACCBraytonCycle2017a_P.CompressorPressureFeedback_Mode == 1) {
    ...
    for (i = 0; i < 6; i++) {
       ...
       */
      rtb_MinMax_j += rtb_Product8_m[i + 1];
    }

    /* Saturate: '<S86>/Saturation1' */
    if (NACCBraytonCycle2017a_B.Product1 >
        NACCBraytonCycle2017a_P.Saturation1_UpperSat) {
      rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_P.Saturation1_UpperSat;
    } else if (NACCBraytonCycle2017a_B.Product1 <
               NACCBraytonCycle2017a_P.Saturation1_LowerSat) {
      rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_P.Saturation1_LowerSat;
    } else {
      rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_B.Product1;
    }

    /* End of Saturate: '<S86>/Saturation1' */
    NACCBraytonCycle2017a_B.ndot_nc = 1.0 /
      (NACCBraytonCycle2017a_P.Constant3_Value * rtb_MinMax_j) *
   ...
   */
  if (!(rtb_MultiportSwitch1_f == NACCBraytonCycle2017a_P.Constant_Value_k)) {
    rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_P.th_const_R /
      rtb_MultiportSwitch1_f;
  } else {
    rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_P.Divide2_value;
  }
   ...
   */
  if ((int32_T)NACCBraytonCycle2017a_P.CompressorPressureFeedback_Mode == 1) {
    rtb_Sum2_k = NACCBraytonCycle2017a_B.p_d;
  } else {
    rtb_Sum2_k = NACCBraytonCycle2017a_P.Constant6_Value;
  }
   ...
   *  Inport: '<Root>/In4'
   */
  rtb_Product7_d = NACCBraytonCycle2017a_U.In4 / rtb_Sum2_p5;
   ...
   */
  rtb_Product4_i = NACCBraytonCycle2017a_B.ndot_c0 * rtb_MinMax_j * rtb_Sum2_p5 *
    (1.0 / rtb_Sum2_k * NACCBraytonCycle2017a_P.pnormal_Value_l) *
    (rtb_MultiportSwitch1_f / NACCBraytonCycle2017a_P.RefrenceRJgK_Value);
   ...
   *  Sum: '<S88>/Add1'
   */
  rtb_MinMax_j = (((real_T)(rtb_Product7_d >
    NACCBraytonCycle2017a_P.CompareToConstant1_const_m) * rtb_Product7_d /
                  ...
                  (real_T)(rtb_Product7_d <
    NACCBraytonCycle2017a_P.CompareToConstant2_const_l) * rtb_Product7_d /
                  NACCBraytonCycle2017a_P.Constant3_Value_b) * rtb_PRatio;

  /* Saturate: '<S88>/p_ratio >= 1' */
  if (rtb_MinMax_j > NACCBraytonCycle2017a_P.p_ratio1_UpperSat) {
    rtb_MinMax_j = NACCBraytonCycle2017a_P.p_ratio1_UpperSat;
  } else {
    if (rtb_MinMax_j < NACCBraytonCycle2017a_P.p_ratio1_LowerSat) {
      rtb_MinMax_j = NACCBraytonCycle2017a_P.p_ratio1_LowerSat;
    }
  }
  ...
  NACCBraytonCycle2017a_B.p2 = rtb_Sum2_k * rtb_MinMax_j;
  ...
  /* Block <S84>/S-Function */
  {
    ...
    /* Map outputs */
    outflow.nr_flows = 1;
    outflow.ndot_ = &NACCBraytonCycle2017a_B.ndot_fl;
  ...
  /* Block <S81>/S-Function*/
  {
    ...
    /* Map inputs */
    inflow.nr_flows = 1;
    inflow.ndot_ = &NACCBraytonCycle2017a_B.ndot_fl;
  ...
  rtb_MinMax_j *= NACCBraytonCycle2017a_B.ndot_e;
   ...
   *  Memory: '<S13>/Memory2'
   */
  rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_DW.Memory2_PreviousInput -
    rtb_MinMax_j * rtb_MinMax_j * NACCBraytonCycle2017a_P.Gain_Gain_d;

  /* MinMax: '<S100>/MinMax' incorporates:
   *  Constant: '<S100>/p_downstrem_min'
   */
  if (!((rtb_MultiportSwitch1_f >
         NACCBraytonCycle2017a_P.p_downstrem_min_Value_e) || rtIsNaN
        (NACCBraytonCycle2017a_P.p_downstrem_min_Value_e))) {
    rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_P.p_downstrem_min_Value_e;
  }

  /* End of MinMax: '<S100>/MinMax' */

  /* Saturate: '<S100>/Saturation' */
  if (rtb_MultiportSwitch1_f > NACCBraytonCycle2017a_P.Saturation_UpperSat_f) {
    ...
    NACCBraytonCycle2017a_B.Saturation_p = rtb_MultiportSwitch1_f;
  }
   ...
   *  Memory: '<S9>/Memory1'
   */
  rtb_MinMax_j = NACCBraytonCycle2017a_DW.Memory1_PreviousInput_b /
   ...
   */
  if (rtb_MinMax_j < 0.0) {
    rtb_Sum2_p5 = -sqrt(fabs(rtb_MinMax_j));
  } else {
    rtb_Sum2_p5 = sqrt(rtb_MinMax_j);
  }
   ...
   *  Inport: '<Root>/In6'
   */
  rtb_UnitOffset *= NACCBraytonCycle2017a_U.In6 *
    NACCBraytonCycle2017a_P.Constant10_Value;
   ...
   *  Switch: '<S113>/Switch'
   */
  if (rtb_UnitOffset > NACCBraytonCycle2017a_DW.Memory2_PreviousInput_o) {
    NACCBraytonCycle2017a_B.Switch2_g =
      NACCBraytonCycle2017a_DW.Memory2_PreviousInput_o;
  } else if (rtb_UnitOffset < NACCBraytonCycle2017a_P.Constant1_Value_g) {
    ...
    NACCBraytonCycle2017a_B.Switch2_g = rtb_UnitOffset;
  }
  ...
  if ((int32_T)NACCBraytonCycle2017a_P.HPGasTurbine_Mode == 1) {
     ...
     *  Product: '<S110>/Product11'
     */
    rtb_MinMax_j = rtb_EfficiencyLookupTable_e;
  } else {
     ...
     *  Sum: '<S108>/Add2'
     */
    rtb_MultiportSwitch1_f = (((real_T)(rtb_Sum2_k >
      ...
      (rtb_Sum2_k < NACCBraytonCycle2017a_P.CompareToConstant2_const_f) *
      rtb_Sum2_k / NACCBraytonCycle2017a_P.Constant2_Value) *
      rtb_mdotequivalent_k;

    /* Saturate: '<S108>/Saturation' */
    if (rtb_MultiportSwitch1_f > NACCBraytonCycle2017a_P.Saturation_UpperSat) {
      rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_P.Saturation_UpperSat;
    } else {
      if (rtb_MultiportSwitch1_f < NACCBraytonCycle2017a_P.Saturation_LowerSat)
      {
        rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_P.Saturation_LowerSat;
      }
    }
    ...
    rtb_Sum2_p5 = NACCBraytonCycle2017a_DW.Memory2_PreviousInput_o /
      NACCBraytonCycle2017a_P.pnormal_Value / rtb_Sum2_p5 *
      rtb_MultiportSwitch1_f;
    ...
    NACCBraytonCycle2017a_B.MultiportSwitch_i = 1.0 / rtb_MultiportSwitch1_f *
      rtb_Sum2_p5;
    ...
    if (rtb_u_j > NACCBraytonCycle2017a_P.Saturation1_UpperSat_k) {
      rtb_MinMax_j = NACCBraytonCycle2017a_P.Saturation1_UpperSat_k;
    } else if (rtb_u_j < NACCBraytonCycle2017a_P.Saturation1_LowerSat_d) {
      rtb_MinMax_j = NACCBraytonCycle2017a_P.Saturation1_LowerSat_d;
    } else {
      rtb_MinMax_j = rtb_u_j;
    }
   ...
   *  Sum: '<S105>/Sum3'
   */
  rtb_MinMax_j = (NACCBraytonCycle2017a_B.Hdot_j -
                  NACCBraytonCycle2017a_B.Hdot_f) *
    (NACCBraytonCycle2017a_P.Gain1_Gain_h * rtb_MinMax_j);

  /* Saturate: '<S105>/Saturation1' */
  if (rtb_MinMax_j > NACCBraytonCycle2017a_P.Saturation1_UpperSat_d) {
    rtb_MinMax_j = NACCBraytonCycle2017a_P.Saturation1_UpperSat_d;
  } else {
    if (rtb_MinMax_j < NACCBraytonCycle2017a_P.Saturation1_LowerSat_ds) {
      rtb_MinMax_j = NACCBraytonCycle2017a_P.Saturation1_LowerSat_ds;
    }
  }
  ...
  /* Sum: '<S105>/Subtract2' */
  NACCBraytonCycle2017a_B.Subtract2_k = rtb_MinMax_j +
    NACCBraytonCycle2017a_B.Hdot_f;
  ...
  rtb_MinMax_j *= NACCBraytonCycle2017a_B.ndot_f;
   ...
   *  Memory: '<S12>/Memory2'
   */
  rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_DW.Memory2_PreviousInput_d -
    rtb_MinMax_j * rtb_MinMax_j * NACCBraytonCycle2017a_P.Gain_Gain_cj;

  /* MinMax: '<S124>/MinMax' incorporates:
   *  Constant: '<S124>/p_downstrem_min'
   */
  if (!((rtb_MultiportSwitch1_f >
         NACCBraytonCycle2017a_P.p_downstrem_min_Value_n) || rtIsNaN
        (NACCBraytonCycle2017a_P.p_downstrem_min_Value_n))) {
    rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_P.p_downstrem_min_Value_n;
  }

  /* End of MinMax: '<S124>/MinMax' */

  /* Saturate: '<S124>/Saturation' */
  if (rtb_MultiportSwitch1_f > NACCBraytonCycle2017a_P.Saturation_UpperSat_l) {
    ...
    NACCBraytonCycle2017a_B.Saturation_lg = rtb_MultiportSwitch1_f;
  }
  ...
  /* Block <S126>/S-Function*/
  {
    ...
    inflow.psi = &NACCBraytonCycle2017a_B.psi_m[0];
   ...
   *  Inport: '<Root>/In10'
   */
  rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_P.UnitScale_Gain_e *
  ...
  if (NACCBraytonCycle2017a_P.Constant1_Value_k == 1.0) {
     ...
     */
    NACCBraytonCycle2017a_MolarFlow(rtb_MultiportSwitch1_f,
      &NACCBraytonCycle2017a_B.ndot_ka);
     ...
     */
    NACCBraytonCycle2017a_MassFlow(rtb_MultiportSwitch1_f,
     ...
     */
    NACCBraytonCycle2017a_B.ndot_ka = rtb_MultiportSwitch1_f *
  ...
  for (i = 0; i < 7; i++) {
     ...
     */
    rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_B.ndot_nc *
      NACCBraytonCycle2017a_B.psi_c[i] + NACCBraytonCycle2017a_B.ndot_o *
      NACCBraytonCycle2017a_B.psi_cv[i];

    /* Sum: '<S147>/Sum2' */
    rtb_Sum2_p5 += rtb_MultiportSwitch1_f;

    /* Sum: '<S147>/Sum1' */
    rtb_Product8_m[i] = rtb_MultiportSwitch1_f;
  }
  ...
  if ((int32_T)NACCBraytonCycle2017a_P.Mixer_p_out_method == 1) {
    ...
    /* Sum: '<S147>/Add1' */
    rtb_MultiportSwitch1_f = NACCBraytonCycle2017a_B.ndot_nc + rtb_UnitOffset;
     ...
     *  Sum: '<S147>/Add2'
     */
    if (!(rtb_MultiportSwitch1_f == NACCBraytonCycle2017a_P.Constant_Value_f)) {
      rtb_UnitOffset = (NACCBraytonCycle2017a_B.p_pg *
                        NACCBraytonCycle2017a_B.ndot_nc +
  ...
  for (i = 0; i < 7; i++) {
     ...
     */
    rtb_MultiportSwitch1_f += NACCBraytonCycle2017a_B.MultiportSwitch1[i] *
      NACCBraytonCycle2017a_P.th_M[i];
  ...
  rtb_MultiportSwitch1_f *= NACCBraytonCycle2017a_B.Add3;

  /* Sum: '<S151>/Sum' incorporates:
   *  Gain: '<S151>/Gain'
   *  Math: '<S151>/Math Function'
   */
  rtb_UnitOffset -= rtb_MultiportSwitch1_f * rtb_MultiportSwitch1_f *
...
static void NACCBraytonCycle2017a_update(void)
{
  ...
  NACCBraytonCycle2017a_DW.Memory1_PreviousInput_j = NACCBraytonCycle2017a_B.T_h;

  /* Update for Memory: '<S12>/Memory2' */
  NACCBraytonCycle2017a_DW.Memory2_PreviousInput_d = NACCBraytonCycle2017a_B.p_g;
  ...
  for (i = 0; i < 7; i++) {
    ...
    NACCBraytonCycle2017a_DW.Memory4_PreviousInput_e[i] =
      NACCBraytonCycle2017a_B.psi_j[i];
  }
  ...
  NACCBraytonCycle2017a_DW.Memory2_PreviousInput_h =
    NACCBraytonCycle2017a_B.p_nt;

  /* Update for Memory: '<S10>/Memory3' */
  NACCBraytonCycle2017a_DW.Memory3_PreviousInput_l =
    NACCBraytonCycle2017a_B.Hdot_ig;
  ...
  NACCBraytonCycle2017a_DW.Memory9_PreviousInput_k =
    NACCBraytonCycle2017a_B.ndot_oo;
  ...
  for (i = 0; i < 7; i++) {
    ...
    NACCBraytonCycle2017a_DW.Memory4_PreviousInput_l[i] =
      NACCBraytonCycle2017a_B.psi_pj[i];
  ...
  NACCBraytonCycle2017a_DW.Memory2_PreviousInput_e = NACCBraytonCycle2017a_B.p_p;
...
static void NACCBraytonCycle2017a_initialize(void)
{
  ...
  /* End of Start for SubSystem: '<S16>/Mixer' */
  {
    ...
    NACCBraytonCycle2017a_DW.Memory1_PreviousInput_j =
      NACCBraytonCycle2017a_P.Memory1_X0_e;
    ...
    NACCBraytonCycle2017a_DW.Memory2_PreviousInput_h =
      NACCBraytonCycle2017a_P.Memory2_X0_n;
    ...
    NACCBraytonCycle2017a_DW.Memory2_PreviousInput_dm =
      NACCBraytonCycle2017a_P.Memory2_X0_e;

    /* InitializeConditions for Memory: '<S7>/Memory1' */
    NACCBraytonCycle2017a_DW.Memory1_PreviousInput_m =
      NACCBraytonCycle2017a_P.Memory1_X0_nh;
...
RT_MODEL_NACCBraytonCycle2017_T *NACCBraytonCycle2017a(void)
{
  ...
  NACCBraytonCycle2017a_P.calculateconversion_l.Saturation2_UpperSat = rtInf;
  NACCBraytonCycle2017a_P.calculateconversion_l.Saturation2_UpperSat_l = rtInf;
...

  {
    ...
    for (i = 0; i < 7; i++) {
      NACCBraytonCycle2017a_B.psi_mv[i] = 0.0;
    }
    ...
    for (i = 0; i < 7; i++) {
      NACCBraytonCycle2017a_B.psi_pj[i] = 0.0;
    }
    ...
    for (i = 0; i < 7; i++) {
      NACCBraytonCycle2017a_B.calculateconversion_l.Product6[i] = 0.0;
    }
    ...
    NACCBraytonCycle2017a_B.Product_p = 0.0;
    NACCBraytonCycle2017a_B.Saturation_l = 0.0;
    NACCBraytonCycle2017a_B.Hdot_g = 0.0;
    ...
    NACCBraytonCycle2017a_B.ndot_fl = 0.0;
    ...
    NACCBraytonCycle2017a_B.calculateconversion_l.Subtract5 = 0.0;
  }
  ...
  NACCBraytonCycle2017a_DW.Memory1_PreviousInput_j = 0.0;
  ...
  NACCBraytonCycle2017a_DW.Memory9_PreviousInput_aq = 0.0;
  NACCBraytonCycle2017a_DW.Memory2_PreviousInput_h = 0.0;
  NACCBraytonCycle2017a_DW.Memory3_PreviousInput_l = 0.0;
  NACCBraytonCycle2017a_DW.Memory9_PreviousInput_k = 0.0;

  {
    int32_T i;
    for (i = 0; i < 7; i++) {
      NACCBraytonCycle2017a_DW.Memory4_PreviousInput_l[i] = 0.0;
    }
  }

  NACCBraytonCycle2017a_DW.Memory2_PreviousInput_dm = 0.0;
  ...
  NACCBraytonCycle2017a_M->Sizes.numBlocks = (648);/* Number of blocks */
  NACCBraytonCycle2017a_M->Sizes.numBlockIO = (245);/* Number of block outputs */
  NACCBraytonCycle2017a_M->Sizes.numBlockPrms = (12799);/* Sum of parameter "widths" */
 ...
 * Source generated on : Wed Mar 20 14:31:44 2019
 *========================================================================*/
...
static NI_Parameter NI_ParamList[] DataSection(".NIVS.paramlist") =
{
  ...
  { 800, "naccbraytoncycle2017a/Initial Condition6/Memory1/X0", offsetof
    (P_NACCBraytonCycle2017a_T, Memory1_X0_e), 0, 1, 2, 1600, 0 },
  ...
  { 803, "naccbraytoncycle2017a/Initial Condition6/Memory2/X0", offsetof
    (P_NACCBraytonCycle2017a_T, Memory2_X0_c), 0, 1, 2, 1606, 0 },
  ...
  { 821, "naccbraytoncycle2017a/Constant4/Value", offsetof
    (P_NACCBraytonCycle2017a_T, Constant4_Value_e), 0, 1, 2, 1642, 0 },

  { 822, "naccbraytoncycle2017a/Initial Condition4/Memory2/X0", offsetof
    (P_NACCBraytonCycle2017a_T, Memory2_X0_n), 0, 1, 2, 1644, 0 },

  { 823,
    "naccbraytoncycle2017a/Combustion Chamber1/Reactor/Pressure loss/Gain/Gain",
    offsetof(P_NACCBraytonCycle2017a_T, Gain_Gain_g), 0, 1, 2, 1646, 0 },

  { 824,
    "naccbraytoncycle2017a/Combustion Chamber1/Reactor/Pressure loss/p_downstrem_min/Value",
    offsetof(P_NACCBraytonCycle2017a_T, p_downstrem_min_Value_p), 0, 1, 2, 1648,
    0 },

  { 825,
    "naccbraytoncycle2017a/Combustion Chamber1/Reactor/Pressure loss/Saturation/UpperLimit",
    offsetof(P_NACCBraytonCycle2017a_T, Saturation_UpperSat_j), 0, 1, 2, 1650, 0
  },

  { 826,
    "naccbraytoncycle2017a/Combustion Chamber1/Reactor/Pressure loss/Saturation/LowerLimit",
    offsetof(P_NACCBraytonCycle2017a_T, Saturation_LowerSat_k), 0, 1, 2, 1652, 0
  },

  { 827, "naccbraytoncycle2017a/Sensor19/Gain2/Gain", offsetof
    (P_NACCBraytonCycle2017a_T, Gain2_Gain_e), 0, 1, 2, 1654, 0 },

  { 828, "naccbraytoncycle2017a/Sensor19/Gain1/Gain", offsetof
    (P_NACCBraytonCycle2017a_T, Gain1_Gain_nb), 0, 1, 2, 1656, 0 },

  { 829, "naccbraytoncycle2017a/Sensor18/addition factor1/Value", offsetof
    (P_NACCBraytonCycle2017a_T, additionfactor1_Value_e), 0, 1, 2, 1658, 0 },

  { 830, "naccbraytoncycle2017a/Sensor18/Gain1/Gain", offsetof
    (P_NACCBraytonCycle2017a_T, Gain1_Gain_ck), 0, 1, 2, 1660, 0 },

  { 831, "naccbraytoncycle2017a/Sensor16/addition factor1/Value", offsetof
    (P_NACCBraytonCycle2017a_T, additionfactor1_Value_hp), 0, 1, 2, 1662, 0 },

  { 832, "naccbraytoncycle2017a/Sensor16/Gain1/Gain", offsetof
    (P_NACCBraytonCycle2017a_T, Gain1_Gain_is), 0, 1, 2, 1664, 0 },

  { 833, "naccbraytoncycle2017a/Sensor17/addition factor1/Value", offsetof
    (P_NACCBraytonCycle2017a_T, additionfactor1_Value_dv), 0, 1, 2, 1666, 0 },

  { 834, "naccbraytoncycle2017a/Sensor17/Gain1/Gain", offsetof
    (P_NACCBraytonCycle2017a_T, Gain1_Gain_j), 0, 1, 2, 1668, 0 },

  { 835, "naccbraytoncycle2017a/Constant8/Value", offsetof
    (P_NACCBraytonCycle2017a_T, Constant8_Value), 0, 1, 2, 1670, 0 },

  { 836, "naccbraytoncycle2017a/Sensor27/addition factor1/Value", offsetof
    (P_NACCBraytonCycle2017a_T, additionfactor1_Value_hc), 0, 1, 2, 1672, 0 },

  { 837, "naccbraytoncycle2017a/Initial Condition1/Memory2/X0", offsetof
    (P_NACCBraytonCycle2017a_T, Memory2_X0_e), 0, 1, 2, 1674, 0 },

  { 838, "naccbraytoncycle2017a/Initial Condition1/Memory1/X0", offsetof
    (P_NACCBraytonCycle2017a_T, Memory1_X0_nh), 0, 1, 2, 1676, 0 },

  { 839, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-normal/Value", offsetof
    (P_NACCBraytonCycle2017a_T, Tnormal_Value), 0, 1, 2, 1678, 0 },

  { 840, "naccbraytoncycle2017a/LP Gas Turbine/RPM/Value", offsetof
    (P_NACCBraytonCycle2017a_T, RPM_Value), 0, 1, 2, 1680, 0 },

  { 841, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/LUTs/Constant/Value",
    offsetof(P_NACCBraytonCycle2017a_T, Constant_Value_j), 0, 1, 2, 1682, 0 },

  { 842, "naccbraytoncycle2017a/Constant11/Value", offsetof
    (P_NACCBraytonCycle2017a_T, Constant11_Value), 0, 1, 2, 1684, 0 },

  { 843, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/Gain/Gain",
    offsetof(P_NACCBraytonCycle2017a_T, Gain_Gain_l), 0, 1, 2, 1686, 0 },

  { 844, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/Gain1/Gain",
    offsetof(P_NACCBraytonCycle2017a_T, Gain1_Gain_d), 0, 1, 2, 1688, 0 },

  { 845, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/Gain2/Gain",
    offsetof(P_NACCBraytonCycle2017a_T, Gain2_Gain_oa), 0, 1, 2, 1690, 0 },

  { 846, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/Gain3/Gain",
    offsetof(P_NACCBraytonCycle2017a_T, Gain3_Gain_p), 0, 1, 2, 1692, 0 },

  { 847, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/Gain4/Gain",
    offsetof(P_NACCBraytonCycle2017a_T, Gain4_Gain_l), 0, 1, 2, 1694, 0 },

  { 848,
    "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/S-Function1/P1",
    offsetof(P_NACCBraytonCycle2017a_T, SFunction1_P1_h[0]), 0, 49, 2, 1696, 0 },

  { 849,
    "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/S-Function1/P2",
    offsetof(P_NACCBraytonCycle2017a_T, SFunction1_P2_m[0]), 0, 49, 2, 1698, 0 },

  { 850,
    "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/S-Function1/P12",
    offsetof(P_NACCBraytonCycle2017a_T, SFunction1_P12_m), 0, 24, 2, 1700, 0 },

  { 851,
    "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/S-Function1/P13",
    offsetof(P_NACCBraytonCycle2017a_T, SFunction1_P13_br[0]), 0, 21, 2, 1702, 0
  },

  { 852,
    "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/S-Function1/P14",
    offsetof(P_NACCBraytonCycle2017a_T, SFunction1_P14_g[0]), 0, 504, 2, 1704, 0
  },

  { 853,
    "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/S-Function1/P15",
    offsetof(P_NACCBraytonCycle2017a_T, SFunction1_P15_k), 0, 1, 2, 1706, 0 },

  { 854,
    "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/S-Function1/P21",
    offsetof(P_NACCBraytonCycle2017a_T, SFunction1_P21_j), 0, 1, 2, 1708, 0 },

  { 855, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/Gain1/Gain", offsetof
    (P_NACCBraytonCycle2017a_T, Gain1_Gain_fh), 0, 1, 2, 1710, 0 },

  { 856, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/Saturation1/UpperLimit",
    offsetof(P_NACCBraytonCycle2017a_T, Saturation1_UpperSat_a), 0, 1, 2, 1712,
    0 },

  { 857, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/Saturation1/LowerLimit",
    offsetof(P_NACCBraytonCycle2017a_T, Saturation1_LowerSat_l), 0, 1, 2, 1714,
    0 },

  { 858, "naccbraytoncycle2017a/Sensor27/Gain2/Gain", offsetof
    (P_NACCBraytonCycle2017a_T, Gain2_Gain_h), 0, 1, 2, 1716, 0 },

  { 859, "naccbraytoncycle2017a/Sensor27/Gain1/Gain", offsetof
    (P_NACCBraytonCycle2017a_T, Gain1_Gain_gr), 0, 1, 2, 1718, 0 },

  { 860, "naccbraytoncycle2017a/Sensor26/addition factor1/Value", offsetof
    (P_NACCBraytonCycle2017a_T, additionfactor1_Value_cl), 0, 1, 2, 1720, 0 },

  { 861, "naccbraytoncycle2017a/Sensor26/Gain1/Gain", offsetof
    (P_NACCBraytonCycle2017a_T, Gain1_Gain_kz), 0, 1, 2, 1722, 0 },

  { 862, "naccbraytoncycle2017a/Sensor24/addition factor1/Value", offsetof
    (P_NACCBraytonCycle2017a_T, additionfactor1_Value_el), 0, 1, 2, 1724, 0 },

  { 863, "naccbraytoncycle2017a/Sensor24/Gain1/Gain", offsetof
    (P_NACCBraytonCycle2017a_T, Gain1_Gain_dv), 0, 1, 2, 1726, 0 },

  { 864, "naccbraytoncycle2017a/Sensor25/addition factor1/Value", offsetof
    (P_NACCBraytonCycle2017a_T, additionfactor1_Value_gl), 0, 1, 2, 1728, 0 },

  { 865, "naccbraytoncycle2017a/Sensor25/Gain1/Gain", offsetof
    (P_NACCBraytonCycle2017a_T, Gain1_Gain_py), 0, 1, 2, 1730, 0 },

  { 866, "naccbraytoncycle2017a/Constant9/Value", offsetof
    (P_NACCBraytonCycle2017a_T, Constant9_Value), 0, 1, 2, 1732, 0 },

  { 867, "naccbraytoncycle2017a/Constant1/Value", offsetof
    (P_NACCBraytonCycle2017a_T, Constant1_Value_f), 0, 1, 2, 1734, 0 },

  { 868, "naccbraytoncycle2017a/Initial Condition5/Memory2/X0", offsetof
    (P_NACCBraytonCycle2017a_T, Memory2_X0_l), 0, 1, 2, 1736, 0 },
  ...
  { 871,
    ...
    offsetof(P_NACCBraytonCycle2017a_T, Saturation_UpperSat_a), 0, 1, 2, 1742, 0
  },

  { 872,
    "naccbraytoncycle2017a/Combustion Chamber/Reactor/Pressure loss/Saturation/LowerLimit",
    offsetof(P_NACCBraytonCycle2017a_T, Saturation_LowerSat_l), 0, 1, 2, 1744, 0
  },
  ...
  { 879,
    ...
    offsetof(P_NACCBraytonCycle2017a_T, Saturation_LowerSat_kk), 0, 1, 2, 1758,
    0 },
...
static int32_t NI_ParamDimList[] DataSection(".NIVS.paramdimlist") =
{
  ...
  7, 7,                                /* Parameter at index 848 */
  7, 7,                                /* Parameter at index 849 */
  24, 1,                               /* Parameter at index 850 */
  1, 21,                               /* Parameter at index 851 */
  24, 21,                              /* Parameter at index 852 */
...
static NI_Signal NI_SigList[] DataSection(".NIVS.siglist") =
{
  ...
  { 29, "naccbraytoncycle2017a/Initial Condition6/Memory9", 0, "ndot", offsetof
    (B_NACCBraytonCycle2017a_T, ndot_f) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1,
    2, 0, 0 },

  { 30, "naccbraytoncycle2017a/Initial Condition6/Memory4", 0, "psi(1, 1)",
    offsetof(B_NACCBraytonCycle2017a_T, psi_m) + (0*sizeof(real_T)), BLOCKIO_SIG,
    14, 1, 2, 0, 0 },

  { 31, "naccbraytoncycle2017a/Initial Condition6/Memory4", 0, "psi(1, 2)",
    offsetof(B_NACCBraytonCycle2017a_T, psi_m) + (1*sizeof(real_T)), BLOCKIO_SIG,
    14, 1, 2, 0, 0 },

  { 32, "naccbraytoncycle2017a/Initial Condition6/Memory4", 0, "psi(1, 3)",
    offsetof(B_NACCBraytonCycle2017a_T, psi_m) + (2*sizeof(real_T)), BLOCKIO_SIG,
    14, 1, 2, 0, 0 },

  { 33, "naccbraytoncycle2017a/Initial Condition6/Memory4", 0, "psi(1, 4)",
    offsetof(B_NACCBraytonCycle2017a_T, psi_m) + (3*sizeof(real_T)), BLOCKIO_SIG,
    14, 1, 2, 0, 0 },

  { 34, "naccbraytoncycle2017a/Initial Condition6/Memory4", 0, "psi(1, 5)",
    offsetof(B_NACCBraytonCycle2017a_T, psi_m) + (4*sizeof(real_T)), BLOCKIO_SIG,
    14, 1, 2, 0, 0 },

  { 35, "naccbraytoncycle2017a/Initial Condition6/Memory4", 0, "psi(1, 6)",
    offsetof(B_NACCBraytonCycle2017a_T, psi_m) + (5*sizeof(real_T)), BLOCKIO_SIG,
    14, 1, 2, 0, 0 },

  { 36, "naccbraytoncycle2017a/Initial Condition6/Memory4", 0, "psi(1, 7)",
    offsetof(B_NACCBraytonCycle2017a_T, psi_m) + (6*sizeof(real_T)), BLOCKIO_SIG,
    14, 1, 2, 0, 0 },

  { 37, "naccbraytoncycle2017a/Combustion Chamber1/Reactor/Product", 0, "",
  ...
  { 39, "naccbraytoncycle2017a/Initial Condition4/Memory3", 0, "Hdot", offsetof
    (B_NACCBraytonCycle2017a_T, Hdot) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2,
    0, 0 },

  { 40, "naccbraytoncycle2017a/Initial Condition1/Memory4", 0, "psi(1, 1)",
    offsetof(B_NACCBraytonCycle2017a_T, psi_p) + (0*sizeof(real_T)), BLOCKIO_SIG,
    14, 1, 2, 0, 0 },

  { 41, "naccbraytoncycle2017a/Initial Condition1/Memory4", 0, "psi(1, 2)",
    offsetof(B_NACCBraytonCycle2017a_T, psi_p) + (1*sizeof(real_T)), BLOCKIO_SIG,
    14, 1, 2, 0, 0 },

  { 42, "naccbraytoncycle2017a/Initial Condition1/Memory4", 0, "psi(1, 3)",
    offsetof(B_NACCBraytonCycle2017a_T, psi_p) + (2*sizeof(real_T)), BLOCKIO_SIG,
    14, 1, 2, 0, 0 },

  { 43, "naccbraytoncycle2017a/Initial Condition1/Memory4", 0, "psi(1, 4)",
    offsetof(B_NACCBraytonCycle2017a_T, psi_p) + (3*sizeof(real_T)), BLOCKIO_SIG,
    14, 1, 2, 0, 0 },

  { 44, "naccbraytoncycle2017a/Initial Condition1/Memory4", 0, "psi(1, 5)",
    offsetof(B_NACCBraytonCycle2017a_T, psi_p) + (4*sizeof(real_T)), BLOCKIO_SIG,
    14, 1, 2, 0, 0 },

  { 45, "naccbraytoncycle2017a/Initial Condition1/Memory4", 0, "psi(1, 6)",
    offsetof(B_NACCBraytonCycle2017a_T, psi_p) + (5*sizeof(real_T)), BLOCKIO_SIG,
    14, 1, 2, 0, 0 },

  { 46, "naccbraytoncycle2017a/Initial Condition1/Memory4", 0, "psi(1, 7)",
    offsetof(B_NACCBraytonCycle2017a_T, psi_p) + (6*sizeof(real_T)), BLOCKIO_SIG,
    14, 1, 2, 0, 0 },
  ...
  { 48, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/Multiport Switch", 0, "",
    offsetof(B_NACCBraytonCycle2017a_T, MultiportSwitch) + (0*sizeof(real_T)),
    BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 49, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/Gain", 0,
    "ndot", offsetof(B_NACCBraytonCycle2017a_T, ndot_i) + (0*sizeof(real_T)),
    BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 50, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/Gain1", 0, "T",
    offsetof(B_NACCBraytonCycle2017a_T, T) + (0*sizeof(real_T)), BLOCKIO_SIG, 0,
    1, 2, 0, 0 },

  { 51, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/Gain2", 0, "p",
  ...
  { 56, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/Gain3", 0,
    "x(1, 5)", offsetof(B_NACCBraytonCycle2017a_T, x) + (4*sizeof(real_T)),
    BLOCKIO_SIG, 14, 1, 2, 0, 0 },

  { 57, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/Gain3", 0,
    "x(1, 6)", offsetof(B_NACCBraytonCycle2017a_T, x) + (5*sizeof(real_T)),
    BLOCKIO_SIG, 14, 1, 2, 0, 0 },

  { 58, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/Gain3", 0,
  ...
  { 63, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/Gain4", 0,
    "psi(1, 5)", offsetof(B_NACCBraytonCycle2017a_T, psi_o) + (4*sizeof(real_T)),
    BLOCKIO_SIG, 14, 1, 2, 0, 0 },

  { 64, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/Gain4", 0,
    "psi(1, 6)", offsetof(B_NACCBraytonCycle2017a_T, psi_o) + (5*sizeof(real_T)),
    BLOCKIO_SIG, 14, 1, 2, 0, 0 },

  { 65, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/Gain4", 0,
  ...
  { 67, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/S-Function1",
    1, "Sdot", offsetof(B_NACCBraytonCycle2017a_T, Sdot) + (0*sizeof(real_T)),
    BLOCKIO_SIG, 66, 1, 2, 0, 0 },

  { 68, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/S-Function1",
    2, "Gdot", offsetof(B_NACCBraytonCycle2017a_T, Gdot) + (0*sizeof(real_T)),
    BLOCKIO_SIG, 66, 1, 2, 0, 0 },

  { 69, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/T-p-x-State/S-Function1",
    3, "Cpdot", offsetof(B_NACCBraytonCycle2017a_T, Cpdot) + (0*sizeof(real_T)),
    BLOCKIO_SIG, 66, 1, 2, 0, 0 },

  { 70, "naccbraytoncycle2017a/LP Gas Turbine/Turbine/Subtract2", 0, "",
    offsetof(B_NACCBraytonCycle2017a_T, Subtract2) + (0*sizeof(real_T)),
    BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 71, "naccbraytoncycle2017a/Combustion Chamber/Reactor/Product", 0, "",
    offsetof(B_NACCBraytonCycle2017a_T, Product_p) + (0*sizeof(real_T)),
    BLOCKIO_SIG, 0, 1, 2, 0, 0 },
  ...
  { 73, "naccbraytoncycle2017a/Initial Condition5/Memory3", 0, "Hdot", offsetof
    (B_NACCBraytonCycle2017a_T, Hdot_g) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1,
    2, 0, 0 },
  ...
  { 234,
    "naccbraytoncycle2017a/LP Gas Turbine/Turbine/H-p-State with Heat Exchange/S-Function",
    8, "psi(1, 1)", offsetof(B_NACCBraytonCycle2017a_T, psi_mv) + (0*sizeof
    (real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 235,
    "naccbraytoncycle2017a/LP Gas Turbine/Turbine/H-p-State with Heat Exchange/S-Function",
    8, "psi(2, 1)", offsetof(B_NACCBraytonCycle2017a_T, psi_mv) + (1*sizeof
    (real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 236,
    "naccbraytoncycle2017a/LP Gas Turbine/Turbine/H-p-State with Heat Exchange/S-Function",
    8, "psi(3, 1)", offsetof(B_NACCBraytonCycle2017a_T, psi_mv) + (2*sizeof
    (real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 237,
    "naccbraytoncycle2017a/LP Gas Turbine/Turbine/H-p-State with Heat Exchange/S-Function",
    8, "psi(4, 1)", offsetof(B_NACCBraytonCycle2017a_T, psi_mv) + (3*sizeof
    (real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 238,
    "naccbraytoncycle2017a/LP Gas Turbine/Turbine/H-p-State with Heat Exchange/S-Function",
    8, "psi(5, 1)", offsetof(B_NACCBraytonCycle2017a_T, psi_mv) + (4*sizeof
    (real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 239,
    "naccbraytoncycle2017a/LP Gas Turbine/Turbine/H-p-State with Heat Exchange/S-Function",
    8, "psi(6, 1)", offsetof(B_NACCBraytonCycle2017a_T, psi_mv) + (5*sizeof
    (real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 240,
    "naccbraytoncycle2017a/LP Gas Turbine/Turbine/H-p-State with Heat Exchange/S-Function",
    8, "psi(7, 1)", offsetof(B_NACCBraytonCycle2017a_T, psi_mv) + (6*sizeof
    (real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },
  ...
  { 361,
    ...
    0, "ndot", offsetof(B_NACCBraytonCycle2017a_T, ndot_fl) + (0*sizeof(real_T)),
    BLOCKIO_SIG, 66, 1, 2, 0, 0 },
  ...
  { 420,
    "naccbraytoncycle2017a/Combustion Chamber1/Reactor/H-p-State with Heat Exchange/S-Function",
    8, "psi(1, 1)", offsetof(B_NACCBraytonCycle2017a_T, psi_pj) + (0*sizeof
    (real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 421,
    "naccbraytoncycle2017a/Combustion Chamber1/Reactor/H-p-State with Heat Exchange/S-Function",
    8, "psi(2, 1)", offsetof(B_NACCBraytonCycle2017a_T, psi_pj) + (1*sizeof
    (real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 422,
    "naccbraytoncycle2017a/Combustion Chamber1/Reactor/H-p-State with Heat Exchange/S-Function",
    8, "psi(3, 1)", offsetof(B_NACCBraytonCycle2017a_T, psi_pj) + (2*sizeof
    (real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 423,
    "naccbraytoncycle2017a/Combustion Chamber1/Reactor/H-p-State with Heat Exchange/S-Function",
    8, "psi(4, 1)", offsetof(B_NACCBraytonCycle2017a_T, psi_pj) + (3*sizeof
    (real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 424,
    "naccbraytoncycle2017a/Combustion Chamber1/Reactor/H-p-State with Heat Exchange/S-Function",
    8, "psi(5, 1)", offsetof(B_NACCBraytonCycle2017a_T, psi_pj) + (4*sizeof
    (real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 425,
    "naccbraytoncycle2017a/Combustion Chamber1/Reactor/H-p-State with Heat Exchange/S-Function",
    8, "psi(6, 1)", offsetof(B_NACCBraytonCycle2017a_T, psi_pj) + (5*sizeof
    (real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 426,
    "naccbraytoncycle2017a/Combustion Chamber1/Reactor/H-p-State with Heat Exchange/S-Function",
    8, "psi(7, 1)", offsetof(B_NACCBraytonCycle2017a_T, psi_pj) + (6*sizeof
    (real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },
  ...
  { 522,
    ...
    0, "", offsetof(B_NACCBraytonCycle2017a_T, calculateconversion_l.Subtract5)
    + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 523,
    "naccbraytoncycle2017a/Combustion Chamber/Reactor/calculate  conversion/Subsystem1/Product6/(1, 1)",
    0, "", offsetof(B_NACCBraytonCycle2017a_T, calculateconversion_l.Product6) +
    (0*sizeof(real_T)), BLOCKIO_SIG, 14, 1, 2, 0, 0 },
...
static const char* NI_CompiledModelDateTime = "Wed Mar 20 14:31:44 2019";
  ...
  * clockTicksNames, int32_t* clockTicks)
{
  ...
  if ((discStates != NULL) && (discStatesNames != NULL)) {
    ...
    discStates[idx] = NIRT_GetValueByDataType
      (&NACCBraytonCycle2017a_DW.Memory1_PreviousInput_j, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&NACCBraytonCycle2017a_DW.Memory1_PreviousInput_j");
    discStates[idx] = NIRT_GetValueByDataType
    ...
    discStates[idx] = NIRT_GetValueByDataType
      (&NACCBraytonCycle2017a_DW.Memory9_PreviousInput_aq, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&NACCBraytonCycle2017a_DW.Memory9_PreviousInput_aq");
    discStates[idx] = NIRT_GetValueByDataType
      (&NACCBraytonCycle2017a_DW.Memory2_PreviousInput_h, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&NACCBraytonCycle2017a_DW.Memory2_PreviousInput_h");
    discStates[idx] = NIRT_GetValueByDataType
      (&NACCBraytonCycle2017a_DW.Memory3_PreviousInput_l, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&NACCBraytonCycle2017a_DW.Memory3_PreviousInput_l");
    discStates[idx] = NIRT_GetValueByDataType
      (&NACCBraytonCycle2017a_DW.Memory9_PreviousInput_k, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&NACCBraytonCycle2017a_DW.Memory9_PreviousInput_k");
    for (count = 0; count < 7; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&NACCBraytonCycle2017a_DW.Memory4_PreviousInput_l, count, 14, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&NACCBraytonCycle2017a_DW.Memory4_PreviousInput_l");
    }

    discStates[idx] = NIRT_GetValueByDataType
      (&NACCBraytonCycle2017a_DW.Memory2_PreviousInput_dm, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&NACCBraytonCycle2017a_DW.Memory2_PreviousInput_dm");
    discStates[idx] = NIRT_GetValueByDataType
  ...
  int32_t* clockTicks)
{
  ...
  if (discStates != NULL) {
    ...
    NIRT_SetValueByDataType(&NACCBraytonCycle2017a_DW.Memory1_PreviousInput_j, 0,
      discStates[idx++], 0, 0);
    ...
    NIRT_SetValueByDataType(&NACCBraytonCycle2017a_DW.Memory9_PreviousInput_aq,
      0, discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&NACCBraytonCycle2017a_DW.Memory2_PreviousInput_h, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&NACCBraytonCycle2017a_DW.Memory3_PreviousInput_l, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&NACCBraytonCycle2017a_DW.Memory9_PreviousInput_k, 0,
      discStates[idx++], 0, 0);
    for (count = 0; count < 7; count++) {
      NIRT_SetValueByDataType(&NACCBraytonCycle2017a_DW.Memory4_PreviousInput_l,
        count, discStates[idx++], 14, 0);
    }

    NIRT_SetValueByDataType(&NACCBraytonCycle2017a_DW.Memory2_PreviousInput_dm,
      0, discStates[idx++], 0, 0);
