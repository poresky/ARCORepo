function params = HotLegTCParams()

%% Define params
cp = 1814.1; %J/kgK 1518 + 2.82*T [deg C] Dowtherm A taking rough
                      % average temp of 105 degrees Celsius 
rho = 990.7; %kg/m3 (Dowtherm A) taking rough average temp of 105 degrees
             % Celsius and saturated liquid properties(from Dowtherm A Heat
             % Transfer Fluid Product Technical Data, Dow Chemical Company)
k_Dow = 0.1259; %W\mk thermal conductivity for Dowtherm A at avg temp of 105C from Dowtherm A Heat
             % Transfer Fluid Product Technical Data, Dow Chemical Company
