function [r, state] = ResGenCIETHeater_1_6(z,state,params,Ts)
% RESGENCIETHEATER_1_6 Sequential residual generator for model 'CIETheater'
% Causality: mixed
%
...
% File generated 25-Apr-2019 13:48:58
  ...
  r=dTSH-PH/(MSH*cpSH)-(ASH*hSH*(TFH-TSH))/(MSH*cpSH); % e17
