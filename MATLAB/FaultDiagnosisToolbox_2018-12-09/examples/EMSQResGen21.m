function [r, state] = EMSQResGen21(z,state,params,Ts)
% EMSQRESGEN21 Sequential residual generator for model 'Electric motor'
% Causality: int
%
...
%
%   for k=1:N
%     [r(k), state] = EMSQResGen21( z(k,:), state, params, 1/fs );
%   end
