function [r, state] = EMSQResGen31(z,state,params,Ts)
% EMSQRESGEN31 Sequential residual generator for model 'Electric motor'
% Causality: int
%
...
%
%   for k=1:N
%     [r(k), state] = EMSQResGen31( z(k,:), state, params, 1/fs );
%   end
