function [r, state] = EMSQResGen13(z,state,params,Ts)
% EMSQRESGEN13 Sequential residual generator for model 'Electric motor'
% Causality: der
%
...
%
%   for k=1:N
%     [r(k), state] = EMSQResGen13( z(k,:), state, params, 1/fs );
%   end
