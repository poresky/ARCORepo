function [r, state] = ResGenHeaterOut_2_1(z,state,params,Ts)
% RESGENHEATEROUT_2_1 Sequential residual generator for model 'HotLeg'
% Causality: int
%
