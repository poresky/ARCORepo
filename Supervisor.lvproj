...
<Project Type="Project" LVVersion="17008000">
	<Property Name="varPersistentID:{01CFF16B-0098-4F04-956B-2044DD5A793D}" Type="Ref">/My Computer/BoP Libraries/BoPOutputs.lvlib/LPT Work Out</Property>
	<Property Name="varPersistentID:{01DD92D1-E961-4D85-B8FB-65CA0A2F43D7}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/BT-65</Property>
	...
	<Property Name="varPersistentID:{04489E17-BCFA-419C-A0C9-1099D1E507FF}" Type="Ref">/My Computer/BoP Libraries/BoPOutputs.lvlib/Hdot HP CTAH Out</Property>
	<Property Name="varPersistentID:{05EFDF08-55F8-40D8-A0FF-84B033FAC0DA}" Type="Ref">/My Computer/BoP Libraries/BoPOutputs.lvlib/Press Compressor Out</Property>
	<Property Name="varPersistentID:{064F51A0-77C8-4A04-89C6-036326701EF9}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/WT-64</Property>
	<Property Name="varPersistentID:{099268DB-D2D2-4962-BCAC-3C24630F0F43}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/ST-13</Property>
	<Property Name="varPersistentID:{0D2A40E0-6B0D-49ED-9F8E-4100AE3963DA}" Type="Ref">/My Computer/BoP Libraries/BoPOutputs.lvlib/Temp Compressor In</Property>
	<Property Name="varPersistentID:{0D65D87B-060A-4A3C-B12A-EA701CFC6047}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/WT-67</Property>
	<Property Name="varPersistentID:{0E5A89F4-5CED-410A-AD74-B4C9DF20E50C}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Flowmeters/FM-60</Property>
	<Property Name="varPersistentID:{0FCFB9E2-2D11-4DAD-879E-143F4ECAF41B}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/CX-11-4</Property>
	<Property Name="varPersistentID:{10BF2388-621D-4C21-ADD6-0436C494A9D9}" Type="Ref">/CIET-PXIe/PXI_Libraries/Core_Variables.lvlib/Shutdown</Property>
	...
	<Property Name="varPersistentID:{12F78206-74AE-463B-8F47-C1A6BBFB3775}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultCore_Variables.lvlib/Power Output_R</Property>
	<Property Name="varPersistentID:{139474DA-10EA-4DE0-B297-D86795F6288D}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/ST-12-SE</Property>
	...
	<Property Name="varPersistentID:{1803F51F-7166-4B1A-B46A-ADCDD4FCBDBB}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/BT-66</Property>
	<Property Name="varPersistentID:{1827C4D3-EEC4-4183-BDCC-7A096E96A888}" Type="Ref">/My Computer/BoP Libraries/BoPOutputs.lvlib/mdot Compressor Out</Property>
	...
	<Property Name="varPersistentID:{1A121EC5-E427-4A74-A63E-B9592F800921}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/CX-11-3</Property>
	<Property Name="varPersistentID:{1A1C835B-EF34-478C-9C43-2568089ADF24}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/WT-24</Property>
	<Property Name="varPersistentID:{1A7D8A31-F047-4E9E-A864-16D13172B1E8}" Type="Ref">/My Computer/RemoteVIVariables.lvlib/Reset CTAH Controller Mode</Property>
	<Property Name="varPersistentID:{1AC1C555-C8EB-49E9-85A9-5AAEB1DC4CC9}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/BT-23</Property>
	<Property Name="varPersistentID:{1B2605FD-F054-401E-B6E8-52FFF7E3EBB1}" Type="Ref">/My Computer/BoP Libraries/BoPInputs.lvlib/LPT PR</Property>
	<Property Name="varPersistentID:{1C53A801-43BF-4909-BAE1-9AFCEF293F78}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/BT-12</Property>
	<Property Name="varPersistentID:{1DDFCDD2-874F-4BAC-B236-72C997711528}" Type="Ref">/My Computer/BoP Libraries/BoPOutputs.lvlib/Press HP CTAH Out</Property>
	<Property Name="varPersistentID:{1E53C1CE-0396-4764-9939-639F28A45206}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/WT-40</Property>
	...
	<Property Name="varPersistentID:{255C5DD1-B2FE-4C4F-BCED-A22D1E54ACD2}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultCore_Variables.lvlib/Input Power Profile Array_R</Property>
	...
	<Property Name="varPersistentID:{27E0501A-177C-40B4-B21E-1BB842EAD356}" Type="Ref">/My Computer/BoP Libraries/BoPOutputs.lvlib/Press LP CTAH Out</Property>
	...
	<Property Name="varPersistentID:{2A7466A2-F606-4822-A860-E4BA6898FB13}" Type="Ref">/CIET-PXIe/PXI_Libraries/VFD_Variables.lvlib/TCHX Variables/TCHX Operating Case</Property>
	<Property Name="varPersistentID:{2AC9C603-367F-4B28-8739-E13F3BF96879}" Type="Ref">/CIET-PXIe/PXI_Libraries/Core_Variables.lvlib/Core Error Out</Property>
	<Property Name="varPersistentID:{2C77BEE0-A2D3-4421-B372-AA1699B41EE8}" Type="Ref">/My Computer/RemoteVIVariables.lvlib/CTAH Mode Memory</Property>
	...
	<Property Name="varPersistentID:{2D5645C0-E72C-4A8C-9264-03CD847FECA6}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultCore_Variables.lvlib/Core Error Out_R</Property>
	<Property Name="varPersistentID:{2E106959-DC41-4FDA-9F1B-5FE703648AFF}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/BT-21</Property>
	...
	<Property Name="varPersistentID:{307CB400-C1C1-4E66-A682-67AC6BAE2E6E}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/ST-11</Property>
	<Property Name="varPersistentID:{30C9279D-8CD2-4ECA-A41D-A2B0761E9EDC}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultVFD_Variables.lvlib/Result TCHX Variables/Activate TCHX_R</Property>
	...
	<Property Name="varPersistentID:{3FAE6BD3-A028-48C3-9BA9-871600B44D1C}" Type="Ref">/My Computer/BoP Libraries/BoPOutputs.lvlib/mdot Combustor Out</Property>
	...
	<Property Name="varPersistentID:{4A4E3DAE-E54C-4AD4-AEF4-B0AA12018425}" Type="Ref">/CIET-PXIe/PXI_Libraries/VFD_Variables.lvlib/GS1 Stop</Property>
	<Property Name="varPersistentID:{4BC8F445-D842-43DD-AEE3-93278E6DC1B3}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/CX-10-4</Property>
	<Property Name="varPersistentID:{4C91FCEB-AA2A-4292-879D-AE34D12699C0}" Type="Ref">/My Computer/BoP Libraries/BoPOutputs.lvlib/mdot LPT Out</Property>
	...
	<Property Name="varPersistentID:{4E6861AB-02DA-442F-9878-9BC89F56784C}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultCore_Variables.lvlib/Output Voltage 2_R</Property>
	<Property Name="varPersistentID:{4EA29241-E465-4124-9D1A-A8F208D8AB0A}" Type="Ref">/CIET-PXIe/PXI_Libraries/VFD_Variables.lvlib/CTAH Variables/CTAH Frequency</Property>
	...
	<Property Name="varPersistentID:{545E74F7-D0FC-4B74-9B19-A66FCE9A4EF3}" Type="Ref">/My Computer/BoP Libraries/BoPOutputs.lvlib/Temp HPT Out</Property>
	<Property Name="varPersistentID:{547948CB-85F5-440E-9CDA-2F758F2D097F}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultCore_Variables.lvlib/Profile Step_R</Property>
	...
	<Property Name="varPersistentID:{5AE6EA67-C2C0-4E94-AA8F-C206E569EC5E}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/BT-11</Property>
	...
	<Property Name="varPersistentID:{5DB47F8D-DBB8-4DAD-8925-07792D334A8E}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultCore_Variables.lvlib/Shutdown_R</Property>
	<Property Name="varPersistentID:{5EA04F6A-BEF6-4F2F-87B7-3C01779FCAC0}" Type="Ref">/CIET-PXIe/PXI_Libraries/Core_Variables.lvlib/Input Power Profile Array</Property>
	<Property Name="varPersistentID:{5F18376E-3EC7-4732-AB34-4B1867725629}" Type="Ref">/My Computer/BoP Libraries/BoPOutputs.lvlib/Hdot Compressor Out</Property>
	<Property Name="varPersistentID:{5F655A26-6D75-4A2F-B6DA-052FA6E09E8D}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/ST-14-S</Property>
	...
	<Property Name="varPersistentID:{5FFAC7B6-FC9C-4D5B-AE4C-8F529EFD6B8B}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/WT-10</Property>
	<Property Name="varPersistentID:{60174BB0-81DB-48DA-A538-1683C3FE2509}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultDAQ_Variables.lvlib/SysFluidTemps_R</Property>
	...
	<Property Name="varPersistentID:{62499EBC-E286-4D23-9E15-C361C94E874B}" Type="Ref">/CIET-PXIe/PXI_Libraries/Core_Variables.lvlib/Power Input Signal</Property>
	<Property Name="varPersistentID:{6303FEF6-5251-4405-BF96-CD98F0AE3FD0}" Type="Ref">/CIET-PXIe/PXI_Libraries/Core_Variables.lvlib/Select Operation Mode</Property>
	...
	<Property Name="varPersistentID:{650DABA6-9720-4180-9E38-27AD8A5108E5}" Type="Ref">/My Computer/BoP Libraries/BoPInputs.lvlib/Ambient Temperature</Property>
	<Property Name="varPersistentID:{650F6F01-8F48-4719-B7F2-AA5CA3798C8A}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Flowmeters/FM-40</Property>
	<Property Name="varPersistentID:{66EB2626-BF61-4074-B003-AC33484B7DF4}" Type="Ref">/My Computer/BoP Libraries/BoPOutputs.lvlib/mdot Compressor In</Property>
	<Property Name="varPersistentID:{679C41CC-8F56-4BC2-838E-E4A4C69A3AD1}" Type="Ref">/My Computer/BoP Libraries/BoPOutputs.lvlib/HPT Work Out</Property>
	<Property Name="varPersistentID:{67B1B193-3E35-4F26-B44D-D53BA6D221F6}" Type="Ref">/CIET-PXIe/PXI_Libraries/VFD_Variables.lvlib/CTAH Variables/CTAH Operating Case</Property>
	<Property Name="varPersistentID:{6841CF19-3872-47FF-B323-12095A449FD5}" Type="Ref">/CIET-PXIe/PXI_Libraries/VFD_Variables.lvlib/Pump Variables/Pump Frequency</Property>
	...
	<Property Name="varPersistentID:{69DED1F7-C0DB-4327-9BA2-3F46A4E46B1A}" Type="Ref">/My Computer/BoP Libraries/BoPInputs.lvlib/Air Flow Rate</Property>
	<Property Name="varPersistentID:{6ABA775A-6120-4A6A-B87A-25F012A0273B}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/ST-14-N</Property>
	<Property Name="varPersistentID:{6CD44A73-CCDE-4B3A-A424-06D542170C5F}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/BT-30</Property>
	...
	<Property Name="varPersistentID:{6DB7CA32-DED8-4576-B1BD-8B87C784970A}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/CX-11-1</Property>
	<Property Name="varPersistentID:{6E7479A0-DEFD-4EF7-8F89-306B10ED9188}" Type="Ref">/My Computer/BoP Libraries/BoPOutputs.lvlib/Temp Combustor Out</Property>
	...
	<Property Name="varPersistentID:{6FD52DC7-75D8-4C18-8254-BC39494A5605}" Type="Ref">/CIET-PXIe/PXI_Libraries/Core_Variables.lvlib/Power Output On</Property>
	<Property Name="varPersistentID:{706C69AD-E501-4850-8014-4EEDF025ECFE}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/ST-12-SW</Property>
	<Property Name="varPersistentID:{7116F48F-61E7-41D0-BB57-D91E353AB91B}" Type="Ref">/My Computer/BoP Libraries/BoPOutputs.lvlib/Press LPT Out</Property>
	<Property Name="varPersistentID:{72CBBE9C-4CD8-46A2-BFA2-410AB5638530}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/WT-42</Property>
	...
	<Property Name="varPersistentID:{7614E70E-2F5A-4B11-A4FB-4FD6FACCC172}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultVFD_Variables.lvlib/GS1 Stop_R</Property>
	<Property Name="varPersistentID:{782FFE80-702A-43DC-82F6-C498D7598939}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Flowmeters/FM-20</Property>
	<Property Name="varPersistentID:{7868F87D-10B0-482C-A28D-EF1676FF0A7F}" Type="Ref">/CIET-PXIe/PXI_Libraries/DAQ_Variables.lvlib/SysSurfTemps</Property>
	<Property Name="varPersistentID:{7872D4DA-BB11-4AF6-BDBA-E02FF86AEB1C}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/WT-33</Property>
	...
	<Property Name="varPersistentID:{806B30C3-E778-4DE1-ADDE-E66AA4541578}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/WT-22</Property>
	<Property Name="varPersistentID:{81A39C1F-25C8-42C0-A52C-05A52A43A08F}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Time</Property>
	<Property Name="varPersistentID:{829196B4-9330-414A-96A9-1017ABE930F5}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultVFD_Variables.lvlib/Result CTAH Variables/Activate CTAH_R</Property>
	<Property Name="varPersistentID:{845D5EE8-198E-41DC-B1A6-82EAD4C12485}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultCore_Variables.lvlib/Select Operation Mode_R</Property>
	<Property Name="varPersistentID:{8509E30D-2EF8-4AA3-BA85-3B78726AFD54}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/BT-25</Property>
	...
	<Property Name="varPersistentID:{8766CB51-6712-45DA-A185-A33598981AD0}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/CX-10-3</Property>
	...
	<Property Name="varPersistentID:{8C105CA9-25AD-43A6-81E8-40398A13883E}" Type="Ref">/My Computer/BoP Libraries/BoPOutputs.lvlib/Temp LPT Out</Property>
	<Property Name="varPersistentID:{8D237FA2-8A8D-4256-A203-1A7423F4E6AC}" Type="Ref">/My Computer/BoP Libraries/BoPInputs.lvlib/Ambient Pressure</Property>
	...
	<Property Name="varPersistentID:{91074198-0A0D-4A68-9055-82D40B87FB11}" Type="Ref">/My Computer/BoP Libraries/BoPInputs.lvlib/Shaft RPM</Property>
	<Property Name="varPersistentID:{9175698F-09DA-4A1A-8DBA-C5D60271018A}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/WT-35</Property>
	<Property Name="varPersistentID:{9245CEE4-A4F2-42C0-A69C-4B171D8D4904}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Flowmeters/FM-30</Property>
	<Property Name="varPersistentID:{97066C9A-7C9D-4610-8282-7688977E1847}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/BT-27</Property>
	...
	<Property Name="varPersistentID:{97DA99D9-76D6-4BCC-9AFA-1AEDE14C82D7}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultVFD_Variables.lvlib/Result TCHX Variables/TCHX Frequency_R</Property>
	...
	<Property Name="varPersistentID:{9ECEA259-C124-46CE-A2E2-6992CA44D0AB}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultVFD_Variables.lvlib/Result CTAH Variables/CTAH Operating Case_R</Property>
	...
	<Property Name="varPersistentID:{A035DAC6-F54F-4DAA-B4FE-14F8FFD4C2FE}" Type="Ref">/My Computer/BoP Libraries/BoPOutputs.lvlib/Press Combustor Out</Property>
	<Property Name="varPersistentID:{A0545A02-3CD4-4E8E-BDC1-C2023275934A}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultDAQ_Variables.lvlib/DAQ?_R</Property>
	<Property Name="varPersistentID:{A05C5C64-7EFE-4080-B1B7-76DCB4B68ADA}" Type="Ref">/My Computer/BoP Libraries/BoPOutputs.lvlib/Press Compressor In</Property>
	<Property Name="varPersistentID:{A271F176-7789-4EE1-B3D4-8A921C57CA29}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultCore_Variables.lvlib/Loop Period_R</Property>
	<Property Name="varPersistentID:{A3A9DC6F-3229-4943-BDD6-A242335B1448}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/BT-29</Property>
	...
	<Property Name="varPersistentID:{A89BD9A1-C7BB-48C0-8E46-0BAB93C97536}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/AT-02</Property>
	<Property Name="varPersistentID:{A8C12D32-A07F-419B-BC47-B671F00B84CC}" Type="Ref">/CIET-PXIe/PXI_Libraries/Core_Variables.lvlib/Output Current 1</Property>
	...
	<Property Name="varPersistentID:{AA6340C3-9DA8-40BD-AABD-7C8FE9644671}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/ST-10</Property>
	<Property Name="varPersistentID:{ABAC4D46-5167-44AE-B86E-1D5CE2A8680A}" Type="Ref">/CIET-PXIe/PXI_Libraries/Core_Variables.lvlib/Output Voltage 2</Property>
	<Property Name="varPersistentID:{ADB5D955-7F33-4A38-83DE-4E24210FA9EC}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/ST-12-N</Property>
	<Property Name="varPersistentID:{ADF0ACAA-CD6D-475F-824C-8EA9237B5D50}" Type="Ref">/My Computer/BoP Libraries/BoPInputs.lvlib/HPT PR</Property>
	...
	<Property Name="varPersistentID:{AEFD6B9D-E02F-4E8E-8FE1-606A392CDEAC}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/ST-14-W</Property>
	<Property Name="varPersistentID:{B18132FB-6A14-48DF-96AF-AA55EEEC54AB}" Type="Ref">/My Computer/BoP Libraries/BoPInputs.lvlib/NG Pressure In</Property>
	<Property Name="varPersistentID:{B1C4D776-AB29-4C3B-A418-069908C64625}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/BT-32</Property>
	...
	<Property Name="varPersistentID:{B2D4693C-E929-4354-9D91-7EAA282168F7}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultVFD_Variables.lvlib/Result CTAH Variables/CTAH Outlet Set-Point_R</Property>
	<Property Name="varPersistentID:{B32A6405-E174-483D-A5A5-EF9CD5848995}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/BT-60</Property>
	<Property Name="varPersistentID:{B45F1F5C-54EC-4B0C-AF8F-EF4E4BF18B6F}" Type="Ref">/CIET-PXIe/PXI_Libraries/VFD_Variables.lvlib/Pump Variables/Activate Pump</Property>
	<Property Name="varPersistentID:{B53A73F4-EF97-489C-8694-9A855D0E9789}" Type="Ref">/CIET-PXIe/PXI_Libraries/Core_Variables.lvlib/Desired Power</Property>
	<Property Name="varPersistentID:{B66E779E-D92B-49EF-9746-B60C52B239F6}" Type="Ref">/My Computer/BoP Libraries/BoPOutputs.lvlib/Hdot LP CTAH Out</Property>
	<Property Name="varPersistentID:{B9324259-9E4A-4A9A-BF48-CC845D7B5D0F}" Type="Ref">/CIET-PXIe/PXI_Libraries/Core_Variables.lvlib/Output Current 2</Property>
	<Property Name="varPersistentID:{B988C9CC-C01B-437A-9AB3-D892D653E098}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultVFD_Variables.lvlib/Result Pump Variables/Activate Pump_R</Property>
	<Property Name="varPersistentID:{BC4DF05B-E0F8-429C-936C-F1AD4B07E15E}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultVFD_Variables.lvlib/Result Pump Variables/Pump Mass Flow Set-Point_R</Property>
	<Property Name="varPersistentID:{BC645C2E-4D13-4317-A222-A21251A46B94}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultCore_Variables.lvlib/Power Input Signal_R</Property>
	<Property Name="varPersistentID:{BDA25B8F-EE6F-41EE-A8CC-40ECE50BEE4E}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/WT-20</Property>
	<Property Name="varPersistentID:{BF42E25E-C5C2-42E6-9147-52C3D7ECA850}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/CX-10-1</Property>
	...
	<Property Name="varPersistentID:{C1E0F9D1-93E7-40B5-950A-66C15B62D4D2}" Type="Ref">/CIET-PXIe/PXI_Libraries/VFD_Variables.lvlib/CTAH Variables/Activate CTAH</Property>
	<Property Name="varPersistentID:{C338BA5D-C143-41E0-93E3-6327CE7EECBA}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/CX-11-2</Property>
	<Property Name="varPersistentID:{C347DF55-A478-4804-83FE-443493217CA6}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultCore_Variables.lvlib/VISA Out_R</Property>
	<Property Name="varPersistentID:{C34E5F06-5DB6-4993-BB1A-2B539766D53B}" Type="Ref">/CIET-PXIe/PXI_Libraries/Core_Variables.lvlib/Exit Profile</Property>
	<Property Name="varPersistentID:{C5C43F39-4BBA-49A3-849F-18E1FF1CD79A}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultCore_Variables.lvlib/Output Current 1_R</Property>
	...
	<Property Name="varPersistentID:{CCE71589-CB87-4BFE-86F5-F9AAA61BFE9B}" Type="Ref">/CIET-PXIe/PXI_Libraries/Core_Variables.lvlib/Profile Step</Property>
	...
	<Property Name="varPersistentID:{CDD10BA5-BF6B-4C36-9174-6AA88DB725DA}" Type="Ref">/CIET-PXIe/PXI_Libraries/DAQ_Variables.lvlib/SysFluidTemps</Property>
	<Property Name="varPersistentID:{CF07BB90-492A-4E9A-8A41-D335868CBA9A}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/CX-10-2</Property>
	<Property Name="varPersistentID:{CFEE3636-AFEC-44AD-9DE8-E60FF7DEA583}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/BT-34</Property>
	<Property Name="varPersistentID:{D1252F0D-25F2-4F20-8DA9-252D4850547C}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/WT-26</Property>
	<Property Name="varPersistentID:{D2572E6D-2C76-4BC0-AB98-143763C60891}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultCore_Variables.lvlib/Desired Power_R</Property>
	<Property Name="varPersistentID:{D33F7CE2-D4B2-49C7-8489-E34F9238AE28}" Type="Ref">/My Computer/BoP Libraries/BoPOutputs.lvlib/mdot HPT Out</Property>
	<Property Name="varPersistentID:{D36568AF-D0FC-472D-B47C-51F515EC568E}" Type="Ref">/My Computer/BoP Libraries/BoPOutputs.lvlib/Hdot HPT Out</Property>
	<Property Name="varPersistentID:{D4286321-1FD7-4E3B-830C-C06DFA6A1862}" Type="Ref">/My Computer/BoP Libraries/BoPOutputs.lvlib/mdot LP CTAH Out</Property>
	<Property Name="varPersistentID:{D529C620-22F5-4989-BA5C-D03B83371EBE}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/ST-14-E</Property>
	<Property Name="varPersistentID:{D7390042-19A5-4F6C-B6B3-4459E1611C2F}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultCore_Variables.lvlib/Power Output On_R</Property>
	<Property Name="varPersistentID:{D8B9CFBF-7EF0-47A6-8D8D-E0431BDDAE48}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/WT-31</Property>
	<Property Name="varPersistentID:{D95D1959-83BB-44F8-8B9D-419E6BD7E48E}" Type="Ref">/CIET-PXIe/PXI_Libraries/ResultDAQ_Variables.lvlib/SysSurfTemps_R</Property>
	<Property Name="varPersistentID:{DB3AC5F2-8850-4857-A2A5-D44EDCE2516F}" Type="Ref">/CIET-PXIe/PXI_Libraries/VFD_Variables.lvlib/TCHX Variables/Activate TCHX</Property>
	<Property Name="varPersistentID:{DB680677-DD7E-433B-914A-CB47578794CE}" Type="Ref">/CIET-PXIe/PXI_Libraries/DAQ_Variables.lvlib/PowersFreqs</Property>
	...
	<Property Name="varPersistentID:{DD0DA166-65A6-4020-9A09-5BB84C226395}" Type="Ref">/CIET-PXIe/PXI_Libraries/VFD_Variables.lvlib/Pump Variables/Pump Mass Flow Set-Point</Property>
	...
	<Property Name="varPersistentID:{DF796841-09CB-45BA-A981-3D98EFD68369}" Type="Ref">/My Computer/BoP Libraries/BoPInputs.lvlib/CTAH 1 Heat Transfer Rate</Property>
	<Property Name="varPersistentID:{E0898EA3-2DCA-4704-AF4A-49907927F63B}" Type="Ref">/CIET-PXIe/PXI_Libraries/Core_Variables.lvlib/VISA Out</Property>
	...
	<Property Name="varPersistentID:{E814E285-0567-40FF-B771-4B424FC8E582}" Type="Ref">/My Computer/RemoteVIVariables.lvlib/Stop CTAH</Property>
	...
	<Property Name="varPersistentID:{EB4B143C-4BE7-46BC-AB64-A05760E36995}" Type="Ref">/CIET-PXIe/PXI_Libraries/Core_Variables.lvlib/Output Voltage 1</Property>
	<Property Name="varPersistentID:{ED0E705A-D32B-492B-86A0-668712B2F27E}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/BT-43</Property>
	<Property Name="varPersistentID:{ED6F129F-0DA4-49E0-BBFA-8AA08E4BDE5D}" Type="Ref">/CIET-PXIe/PXI_Libraries/Core_Variables.lvlib/Loop Period</Property>
	<Property Name="varPersistentID:{ED7FAFA8-B89D-4520-B296-33022CB77B37}" Type="Ref">/My Computer/BoP Libraries/BoPOutputs.lvlib/Temp LP CTAH Out</Property>
	...
	<Property Name="varPersistentID:{F12DAD20-E196-4200-BB70-C7FC71C7F6D9}" Type="Ref">/CIET-PXIe/PXI_Libraries/NPSVariables.lvlib/Thermocouples/BT-63</Property>
	...
	<Property Name="varPersistentID:{F9775419-47AB-4662-8C24-ED64FF1BEFC7}" Type="Ref">/CIET-PXIe/PXI_Libraries/DAQ_Variables.lvlib/DAQ?</Property>
...
DirectoryIndex index.htm
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Brain_Distribution" Type="Source Distribution">
				...
				<Property Name="Source[0].itemID" Type="Str">{BADA8126-E441-45E8-B0A4-FAAE353C9570}</Property>
