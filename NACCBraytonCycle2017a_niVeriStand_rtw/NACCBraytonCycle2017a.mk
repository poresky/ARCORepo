# File    : NACCBraytonCycle2017a.mk (for Release 2010b and later)
#
# Abstract:
...
MODULES         		= NACCBraytonCycle2017a_data.c ni_modelframework.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging.c
MAKEFILE        		= NACCBraytonCycle2017a.mk
...
MASTER_ANCHOR_DIR    	= 
START_DIR          		= C:\Users\Darcy\Desktop\BoP
S_FUNCTIONS     		= 
S_FUNCTIONS_LIB 		= C:\PROGRA~2\EUTECH~1\THERMO~1\5404C4~1.0\blocks\lib\TH_FUN~1.LIB C:\PROGRA~2\EUTECH~1\THERMO~1\5404C4~1.0\blocks\lib\TH_FUN~2.LIB
SOLVER          		= 
NUMST           		= 1
TID01EQ         		= 0
NCSTATES        		= 0
BUILDARGS       		=  ISPROTECTINGMODEL=NOTPROTECTING EXT_MODE=0 EXTMODE_STATIC_ALLOC=0 TMW_EXTMODE_TESTING=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 MAT_FILE=1 NIDEBUG=0 NIOPT="Default" OPTS=""
MULTITASKING    		= 0
EXT_MODE        		= 0
...
NIVERISTAND_ROOT		= C:\VeriStand\2018
...
MODELLIB                  				= NACCBraytonCycle2017alib.lib
MODELREF_LINK_LIBS        		= 
MODELREF_LINK_RSPFILE			= NACCBraytonCycle2017a_ref.rsp
MODELREF_INC_PATH				= 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\NACCBraytonCycle2017a_niVeriStand_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\PROGRA~2\EUTECH~1\THERMO~1\5404C4~1.0\blocks\lib
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\PROGRA~2\EUTECH~1\THERMO~1\5404C4~1.0\blocks\include
