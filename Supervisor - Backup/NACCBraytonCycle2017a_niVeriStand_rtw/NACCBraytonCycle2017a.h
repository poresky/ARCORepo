...
typedef struct {
  ...
  real_T ndot_f;                       /* '<S12>/Memory9' */
  real_T psi_m[7];                     /* '<S12>/Memory4' */
  real_T Product;                      /* '<S70>/Product' */
  real_T Saturation;                   /* '<S72>/Saturation' */
  real_T Hdot;                         /* '<S10>/Memory3' */
  real_T psi_p[7];                     /* '<S7>/Memory4' */
  ...
  real_T Hdot_h;                       /* '<S138>/S-Function1' */
  real_T Sdot;                         /* '<S138>/S-Function1' */
  real_T Gdot;                         /* '<S138>/S-Function1' */
  real_T Cpdot;                        /* '<S138>/S-Function1' */
  real_T Subtract2;                    /* '<S129>/Subtract2' */
  real_T Product_p;                    /* '<S62>/Product' */
  real_T Saturation_l;                 /* '<S64>/Saturation' */
  real_T Hdot_g;                       /* '<S11>/Memory3' */
  ...
  real_T Saturation_lg;                /* '<S124>/Saturation' */
  ...
  real_T Hdot_h5;                      /* '<S152>/S-Function1' */
  ...
  real_T psi_mv[7];                    /* '<S131>/S-Function' */
  ...
  real_T ndot_oo;                      /* '<S71>/S-Function' */
  real_T T_mo;                         /* '<S71>/S-Function' */
  real_T p_k;                          /* '<S71>/S-Function' */
  real_T Hdot_jo;                      /* '<S71>/S-Function' */
  real_T Sdot_o;                       /* '<S71>/S-Function' */
  real_T Gdot_g;                       /* '<S71>/S-Function' */
  real_T Cpdot_az;                     /* '<S71>/S-Function' */
  real_T x_i[7];                       /* '<S71>/S-Function' */
  real_T psi_pj[7];                    /* '<S71>/S-Function' */
  real_T Qenv_pj;                      /* '<S71>/S-Function' */
  real_T num_iterations_fx;            /* '<S71>/S-Function' */
  real_T ndot_f2;                      /* '<S63>/S-Function' */
  real_T T_h3;                         /* '<S63>/S-Function' */
  real_T p_nt;                         /* '<S63>/S-Function' */
  real_T Hdot_ig;                      /* '<S63>/S-Function' */
  real_T Sdot_fv;                      /* '<S63>/S-Function' */
  real_T Gdot_mk;                      /* '<S63>/S-Function' */
  real_T Cpdot_eg;                     /* '<S63>/S-Function' */
  real_T x_il[7];                      /* '<S63>/S-Function' */
  real_T psi_j[7];                     /* '<S63>/S-Function' */
  real_T Qenv_f;                       /* '<S63>/S-Function' */
  real_T num_iterations_h;             /* '<S63>/S-Function' */
  ...
  real_T Gdot_ny;                      /* '<S56>/S-Function1' */
  ...
  int32_T error_codes_h;               /* '<S71>/S-Function' */
  int32_T error_codes_or;              /* '<S63>/S-Function' */
  ...
  B_calculateconversion_NACCBra_T calculateconversion;/* '<S70>/calculate  conversion' */
  B_calculateconversion_NACCBra_T calculateconversion_l;/* '<S62>/calculate  conversion' */
...
typedef struct {
  ...
  real_T Memory9_PreviousInput_d;      /* '<S12>/Memory9' */
  real_T Memory4_PreviousInput_m[7];   /* '<S12>/Memory4' */
  real_T Memory1_PreviousInput_j;      /* '<S12>/Memory1' */
  real_T Memory2_PreviousInput_d;      /* '<S12>/Memory2' */
  real_T Memory3_PreviousInput_k;      /* '<S12>/Memory3' */
  ...
  real_T Memory4_PreviousInput_e[7];   /* '<S10>/Memory4' */
  real_T Memory9_PreviousInput_aq;     /* '<S10>/Memory9' */
  real_T Memory2_PreviousInput_h;      /* '<S10>/Memory2' */
  real_T Memory3_PreviousInput_l;      /* '<S10>/Memory3' */
  real_T Memory9_PreviousInput_k;      /* '<S7>/Memory9' */
  real_T Memory4_PreviousInput_l[7];   /* '<S7>/Memory4' */
  real_T Memory2_PreviousInput_dm;     /* '<S7>/Memory2' */
  real_T Memory1_PreviousInput_m;      /* '<S7>/Memory1' */
  real_T Memory8_PreviousInput[7];     /* '<S7>/Memory8' */
  real_T Memory4_PreviousInput_i[7];   /* '<S11>/Memory4' */
  real_T Memory9_PreviousInput_b;      /* '<S11>/Memory9' */
  real_T Memory2_PreviousInput_e;      /* '<S11>/Memory2' */
  real_T Memory3_PreviousInput_m;      /* '<S11>/Memory3' */
  ...
  real_T SFunction_T_CAL_DWORK_l;      /* '<S71>/S-Function' */
  real_T SFunction_T_CAL_DWORK_j;      /* '<S63>/S-Function' */
  ...
  void *SFunction_PWORK_j[4];          /* '<S71>/S-Function' */
  void *SFunction_PWORK_o[4];          /* '<S63>/S-Function' */
...
struct P_NACCBraytonCycle2017a_T_ {
  ...
  real_T additionfactor1_Value_ok;     /* Expression: add_fac
                                        ...
                                        */
  real_T Memory1_X0_e;                 /* Expression: T
  ...
  real_T Constant4_Value_e;            /* Expression: 1
                                        ...
                                        */
  real_T Memory2_X0_n;                 /* Expression: p
  ...
  real_T additionfactor1_Value_hc;     /* Expression: add_fac
                                        ...
                                        */
  real_T Memory2_X0_e;                 /* Expression: p
                                        * Referenced by: '<S7>/Memory2'
                                        */
  real_T Memory1_X0_nh;                /* Expression: T
  ...
  real_T Saturation_UpperSat_p;        /* Expression: 1.2
                                        ...
                                        */
  real_T Saturation_LowerSat_kk;       /* Expression: 0.8
                                        * Referenced by: '<S86>/Saturation'
                                        */
  ...
  real_T PFin_Value;                   /* Expression: 0
                                        ...
                                        */
  real_T Constant10_Value;             /* Expression: 100000
  ...
  P_calculateconversion_NACCBra_T calculateconversion;/* '<S70>/calculate  conversion' */
  P_calculateconversion_NACCBra_T calculateconversion_l;/* '<S62>/calculate  conversion' */
